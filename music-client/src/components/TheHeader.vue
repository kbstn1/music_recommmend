  ...
  <div class="the-header">
    ...
    <div class="header-logo">
      ...
      <ul class="navbar" ref="change">
        <li :class="{active: item.name === activeName}" v-for="item in navMsg" :key="item.index" @click="goPage(item.path, item.name)">
          {{item.name}}
        </li>
      </ul>
    </div>
    ...
    <ul class="header-right" v-show="!loginIn">
...
export default {
  ...
  mounted () {
    document.querySelector('.userbar').addEventListener('click', function (e) {
